    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._hermes_configured_scope = (
            configured_scope.strip()
            if isinstance(configured_scope, str) and configured_scope.strip()
            else None
        )
        ...
        while True:
            ...
            try:
                ...
                while True:
                    ...
                    # through one generator. Only discovery URLs receive the optional client
                    # identity; an explicit configured scope remains authoritative over a
                    # broader provider challenge or protected-resource metadata.
